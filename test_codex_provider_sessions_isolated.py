...
import tests.test_codex_subagent_config_isolated as config_fixture
...
def make_namespace(root: Path):
    ...
    ns = {"Any": Any, "Literal": Literal, "BaseModel": BaseModel, "Field": Field,
        ...
        "server_instances": server_instances, "local_history_import_guard": nullcontext,
        "other_local_instance_provider_keys": lambda: set(),
        "BACKEND_OPENCODE": "opencode", "OPENCODE_DEFAULT_PERMISSION_MODE": "default",
        "OPENCODE_PERMISSION_MODES": ["default"],
        "effective_opencode_permission_mode": lambda session: "default",
        ...
        "ensure_opencode_permission_mode_update_allowed": AsyncMock(),
