...
NEW_MODULES = {
    "claude_history_repair.py", "claude_history_provenance.py",
}
BASELINE_MIGRATION = "migrations/0016_team_message_all_servers.sql"
...
class ReleaseFileManifestTests(unittest.TestCase):
    ...
    def test_package_and_installer_preserve_exact_hub_members(self):
        ...
        self.assertIn(BASELINE_MIGRATION, package)
        ...
        with tempfile.TemporaryDirectory(prefix="release-hub-manifest-") as temporary:
            ...
            (staged / BASELINE_MIGRATION).unlink()
            with self.assertRaisesRegex(SystemExit, re.escape(BASELINE_MIGRATION)):
                self.manifest["validate_release_directory"](staged)
    ...
    def test_frozen_hub_manifest_preserves_baseline_members_and_hashes(self):
        ...
        self.assertIn(BASELINE_MIGRATION, expected)
