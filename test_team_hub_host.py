...
class VendoredTeamHubParityTests(unittest.TestCase):
    def test_vendored_runtime_matches_frozen_source_manifest_without_generated_files(self) -> None:
        ...
        expected = {
            ...
            "migrations/0010_team_attachment_orphan_reclamation.sql": "d472b0c8af0908e04740000c5d3506d48c14162fbe04b36cd8b25757f6f05c60",
            ...
            "store.py": "7ca782aee22480e24d8bc0d5967c7cba2483b0378327c580dbfce2b6cddba47f",
        }
