...
NAMES = {"probe_runtime", "runtime_diagnostic_payload", "safe_runtime_version", "auth_failure_text",
         "discover_runtime_catalog", "discover_runtime_catalog_within_budget", "discover_runtime_backend_catalog", "ensure_runtime_available"}
...
class CodexProviderReadinessTests(unittest.IsolatedAsyncioTestCase):
    def setUp(self):
        ...
        self.ns = {"Any": object, "Path": Path, "re": re, "time": time, "json": json, "subprocess": subprocess,
            ...
            "RUNTIME_CATALOG_DEADLINE": ContextVar("isolated_catalog_deadline", default=None),
            "RUNTIME_CATALOG_BUDGET_SECONDS": 2.0, "CLAUDE_AUTH_PROBE_TIMEOUT_SECONDS": 20.0,
            "VALID_BACKENDS": {"codex", "claude", "cursor", "opencode"},
            "BACKEND_OPENCODE": "opencode", "OPENCODE_PERMISSION_MODES": [],
            "OPENCODE_DEFAULT_PERMISSION_MODE": "default", "runtime_catalog_budget_expired": lambda: False,
