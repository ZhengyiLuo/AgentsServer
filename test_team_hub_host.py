...
class ManagedTeamHubHostTests(unittest.IsolatedAsyncioTestCase):
    async def test_direct_ip_endpoint_requires_explicit_exact_plaintext_route(self) -> None:
        ...
        for invalid in (
            "http://atlas.local:7850/api/team-hub",
            "https://100.64.0.1:7850/api/team-hub",
            "http://100.64.0.1:7851/api/team-hub",
            "http://127.0.0.1:7850/api/team-hub",
            "http://100.64.0.001:7850/api/team-hub",
            "http://user:secret@100.64.0.1:7850/api/team-hub",
            "http://100.64.0.1:7850/api/team-hub/",
            "http://100.64.0.1:7850/api/team-hub?token=secret",
        ):
    ...
    async def test_tailnet_endpoint_configuration_is_exact_and_fail_closed(self) -> None:
        ...
        for invalid in (
            "http://atlas.example.ts.net:8444/api/team-hub",
            "https://atlas.example.ts.net/api/team-hub",
            "https://atlas.example.ts.net:443/api/team-hub",
            "https://100.64.0.1:8444/api/team-hub",
            "https://a.ts.net:8444/api/team-hub",
            "https://xn--atlas.example.ts.net:8444/api/team-hub",
            "https://ATLAS.example.ts.net:8444/api/team-hub",
            "https://atlas.example.ts.net.:8444/api/team-hub",
            "https://user:secret@atlas.example.ts.net:8444/api/team-hub",
            "https://atlas.example.ts.net:8444/api/team-hub/",
            "https://atlas.example.ts.net:8444/api/team-hub?token=secret",
            "https://atlas.example.ts.net:8444/api/team-hub#fragment",
        ):
            transport, hub_url, host_name, error = configured_team_hub_endpoint(
                TEAM_HUB_MODE_HOST,
                invalid,
